	...
	layer.open({
		...
		content: '<div class="bt-form pd20 pd70" style="padding:20px 35px;">\
                ...
                <div class="details" style="margin-top:5px;padding-left: 3px;">\
					...
					<label style="font-weight: 400;margin: 3px 5px 0px;" for="check_port">I already understand</label>,<a target="_blank" class="btlink" href="https://www.google.com">How to release the port?</a>\
				</div>\
			</div>',
		...
		layer.open({
			...
			content: '<div class="bt-form pd20 pd70 ssl_cert_from google_verify" style="padding:20px 35px;">\
				...
				<div class="details" style="width: 90%;margin-bottom:10px;">\
					...
					<a target="_blank" class="btlink" href="https://www.google.com">Learn more</a>\
				</div>\
	...
	layer.open({
		...
		content: '<div class="bt-form pd20" style="padding:20px 35px;">\
					...
					<div class="verify_tips">\
						<p>Tips: Please use the "Google Authenticator APP" binding to support Android, IOS system.<a href="https://www.google.com" class="btlink" target="_blank">Use tutorial</a></p>\
		...
		bt.send('get_cert_source', 'config/get_cert_source', {}, function (rdata) {
			...
			var _data = {
				...
				list: [
					...
					{
						html: '<div class="details"><input type="checkbox" id="checkSSL" /><label style="font-weight: 400;margin: 3px 5px 0px;" for="checkSSL">' + lan.config.ssl_open_ps_4 + '</label><a target="_blank" class="btlink" href="https://www.google.com">' + lan.config.ssl_open_ps_5 + '</a></p></div>'
					}
		...
		layer.open({
			...
			content: ' <div class="bt-form bt-form" style="padding:15px 25px">\
                        ...
                        <ul class="help-info-text c7">\
                            ...
                            <li>'+ lan.config.help3 + '：<a class="btlink" href="https://www.google.com" target="_blank">https://www.google.com</a></li>\
                        </ul>\
                    </div>'
		})
	});
